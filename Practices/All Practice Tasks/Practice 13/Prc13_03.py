def main():
    ...
    f2.write(str (count_3)+'\n')
    f2.write(str (count_4)+'\n')
    f2.write(str (count_5)+'\n')
    f2.write(str (count_6)+'\n')
    f2.write(str (count_7)+'\n')
    f2.write(str (count_8)+'\n')
    f2.write(str (count_9))
    f2.close()
    
    print ('New File Created Containing integers, Where The Program is')
